...
noise_std = 0.20 * I  # % noise proportional to cases
...
SEIR_observation_noise_data = pd.DataFrame({"time": t_norm,"I": I_norm,})
print(SEIR_observation_noise_data)

csv_path = os.path.join(data_folder, "SEIR_observation_noise_data.csv")
SEIR_observation_noise_data.to_csv(csv_path, index=False)